...
const BASE_URL = IS_DEV ? 'http://localhost:3000' : (process.env.NEXT_PUBLIC_BASE_URL || 'https://dantizt.ru');
...
export function middleware(request) {
  ...
  // Получаем роль из куки (проверяем как с суффиксом _native, так и без него)
